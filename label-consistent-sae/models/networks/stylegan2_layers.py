...
class Discriminator(nn.Module):
    def __init__(self, size, channel_multiplier=2, blur_kernel=[1, 3, 3, 1], double_final_linear=False):
        super().__init__()
        ...
        self.final_linear = nn.Sequential(
            # EqualLinear(channels[4] * (side_length ** 2), channels[4], activation='fused_lrelu'), # SOLT modification!
            EqualLinear(channels[4] * (side_length ** 2) * 2 if double_final_linear else channels[4] * (side_length ** 2),
